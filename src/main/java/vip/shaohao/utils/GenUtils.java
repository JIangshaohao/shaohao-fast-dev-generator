...
import vip.shaohao.entity.ColumnEntity;
import vip.shaohao.entity.TableEntity;
import vip.shaohao.entity.mongo.MongoDefinition;
import vip.shaohao.entity.mongo.MongoGeneratorEntity;
...
public class GenUtils {
    ...
    public static void generatorCode(Map<String, String> table,
        ...
        mainPath = StringUtils.isBlank(mainPath) ? "vip.shaohao" : mainPath;
        //封装模板数据
